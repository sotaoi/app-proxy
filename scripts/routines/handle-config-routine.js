...
// const { gatewayStatusRoutine } = require('../routines/gateway-status-routine');

const handleConfigRoutine = async (readRoutesDirpath, appInfo, appPocket) => {
  // const configJson = {
  //   appPocket,
  //   appInfo,
  //   routes: [],
...
module.exports = { handleConfigRoutine };
...
// const handleConfigRoutine = async (appInfo, appPocket) => {
//   const configJson = {
//     appPocket,
//     appInfo,
//   };
